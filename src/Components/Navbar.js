    ...
    return (
        <div className="w-full fixed top-0 left-1 shadow-md shadow-gray-800 z-10">
            <div className="bg-black items-center justify-between p-6 md:flex">
                ...
                <ul className={`bg-black w-full absolute left-0 pl-6 z-[-1] lg:space-x-4 md:space-x-4 md:flex md:items-center md:pb-0 md:static md:z-auto md:w-auto md:pl-0 ${open ? "top-15 space-x-0" : "top-[-500px] space-x-4"}`}>
                    {
                        Refs.map((Ref) => (
