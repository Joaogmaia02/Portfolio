...
export default function Footer() {
    return (
        <footer className="text-gray-400 bg-gray-800 body-font z-50">
            <div class="items-center justify-between p-6 md:flex">
                ...
                <div className="flex float-right space-x-6">
                    ...
                    <a href="https://github.com/murilostorari" target="_blank" rel="noopener noreferrer" data-te-toggle="tooltip" title="Meu GitHub"><img className="w-6 hover:scale-105 transition-all duration-200 cursor-pointer" src="./img/icons/rocket.png" alt="Meu GitHub"></img></a>
                </div>
            </div>
        </footer>
    );
